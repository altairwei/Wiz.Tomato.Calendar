...
export default function EventDetailForm(props) {
    ...
    const handleTitleChange = props.onTitleChange;
    const handleStartChange = props.onStartChange;
    const handleEndChange = props.onEndChange;
    const handleColorChange = props.onColorchange;

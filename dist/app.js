...
/******/ 	var hotCurrentHash = "970812d53cf77e6cf0ee"; // eslint-disable-line no-unused-vars
    ...
    renderRepeatForm() {
        ...
        this.renderFormComponent(this.repeatForm, [
            {//重复规则
                ...
                renderer: _Widget_BootstrapSelect__WEBPACK_IMPORTED_MODULE_6__["createBootstrapSelect"],
                eventName: 'changed.bs.select',
                handle: (e, clickedIndex, newValue, oldValue, a) => {
                    if ( clickedIndex == 4 ) {
